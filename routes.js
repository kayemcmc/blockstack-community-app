...
const screens = {
  ...
  Cards: {
    ...
    navigationOptions: {
      drawerLabel: 'Cards',
      drawerIcon: props => (
        <MenuIcon name="grid-square" family="Galio" focused={props.focused} />
      ),
    },
  },
  Article: {
  ...
  Dashboard: {
    ...
    navigationOptions: {
      ...
      drawerIcon: props => (
        <MenuIcon name="analytics" family="Galio" focused={props.focused} />
      ),
    },
  },
  News: {
    ...
    navigationOptions: {
      ...
      drawerIcon: props => (
        <MenuIcon name="paper-2" family="Galio" focused={props.focused} />
      ),
    },
  },
  Presentation: {
    ...
    navigationOptions: {
      ...
      drawerIcon: props => (
        <MenuIcon name="presentation" family="Galio" focused={props.focused} />
      ),
    },
  },
  Login: {
    ...
    navigationOptions: {
      ...
      drawerIcon: props => (
        <MenuIcon name="log-in" family="Galio" focused={props.focused} />
      ),
    },
  },
  Register: {
    ...
    navigationOptions: {
      ...
      drawerIcon: props => (
        <MenuIcon name="add-27" family="Galio" focused={props.focused} />
      ),
    },
  },
  Grid: {
    ...
    navigationOptions: {
      ...
      drawerIcon: props => (
        <MenuIcon name="grid-48" family="Galio" focused={props.focused} />
      ),
    },
  },
};
